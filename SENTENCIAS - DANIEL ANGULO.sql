...
/* Creación del usuario de "analista1", solo tendrá permiso a consultar las tablas.
...
grant select on startup_bicicletas.usuarios to 'SB_analista1'@'localhost';

-- show grants for 'analista1'@'localhost';

/* Creación del usuario de "admin1", el cual tendrá permisos de leer, insertar y modificar registros.
 sentencia para crear usuario y se le asigna la contraseña. */
...
grant select, INSERT, UPDATE on startup_bicicletas.usuarios to 'SB_admin1'@'localhost';
